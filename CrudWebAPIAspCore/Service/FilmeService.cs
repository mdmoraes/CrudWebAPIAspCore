...
namespace CrudWebAPIAspCore.Service
{
    public class FilmeService : IFilmeService
    {
        ...
        public FilmeService()
        {
            ...
            {
                new Filme { Id = 1, Titulo = "Moscou contra 007", AnoLancamento = 1983, Resumo = "um agente a serviço da SPECTRE, revela um plano de roubar o criptógrafo Lektor dos soviéticos e vendê-lo novamente aos mesmos, e simultaneamente se vingar de James pelo assassinato de Dr. No." },
